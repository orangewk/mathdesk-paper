...
# Conclusion
The central claim of this paper is not that LLMs can teach mathematics — that capacity is already evident from benchmark results. The central claim is that *how* an LLM teaches mathematics can be controlled, and that the mechanism of control is a four-layer architecture operating above the model itself.
